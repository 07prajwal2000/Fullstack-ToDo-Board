...
import { AddTodoListDto, AddTodoListValidator, ApiResponse, TodoListType } from "../models/todoListModel";
import TodoItem, { TodoItemDto, TodoItemDtoValidator } from "../models/todoItemModel";
...
export default function MapTodosController(app: Express, client: MongoClient) {
  ...
  todoListServices = new TodoListServices(todosCollection, todoBoardCollection);
  todoItemServices = new TodoItemServices(todosCollection, todoBoardCollection);
